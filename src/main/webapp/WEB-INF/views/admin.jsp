...
String commonPath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+cpath+"/";
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <li class="">
                        <a class="popstyle" href="${commonPath }sys/aclModule/acl.page" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            权限管理
                        </a>
                        <b class="arrow"></b>
